...
namespace DemoConsole
{
    class Program
    {
        ...
        /// </summary>
        /// <param name="orderId">The ID of the order shipped</param>
    ...
    /// <summary>
    /// Represents information about the shipper and tracking/freight
    /// details for shipping an order.
    /// </summary>
    public class ShippingDirections
    {
        /// <summary>Primary Key of the Shipper</summary>
        public int ShipperId { get; set; }
        /// <summary>Tracking Code for checking shipment progress ionline</summary>
